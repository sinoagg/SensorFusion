...
#define DONGFENG_VEHICLE_SWITCH_ADDR	0x0CFDCC00	//00 = xx, 3.1.17 OEL Operators External Light, 3.1.18 front Operator Wiper and Washer
#define DONGFENG_VEHICLE_BRAKE_ADDR		0x0C040B2A	//send to EBS
...
#define VEHICLE_MODEL DONGFENG
	...
	#define VEHICLE_BRAKE_ADDR	DONGFENG_VEHICLE_BRAKE_ADDR
